...
class TiledImageMaskDatasetGenerator:
  ...
  def create_mask_files(self, mask_file, index):
    ...
    if self.include_resized:   
      ...
      if self.augmentation:
          self.augment(mask, basename, border=(0, 0, 0), ismask=True)
  ...
  def create_image_files(self, image_file, index):
    ...
    if self.include_resized: 
      ...
      print("--- Saved {}".format(filepath))
      if self.augmentation:
        self.augment(image, basename, output_images_dir, border=(0, 0, 0), ismask=False)
  ...
  def generate(self, input_images_dir, input_masks_dir, 
    ...
    mask_files = glob.glob(input_masks_dir + "/*_GT.png")
    ...
    index = 10000
    exclude_files = ["EDF000_GT.png", "EDF001_GT.png", "EDF002_GT.png", "EDF003_GT.png"]
...
if __name__ == "__main__":
  try:
    # 1024x1024 pixels dataset
    # We excluded the following files to generate this tiled-dataset.
    # EDF000.png ~ EDF003.png
    # EDF000_GT.png ~ EDF003_GT.png
    
    images_dir  = "./EDF/"
    masks_dir   = "./EDF/"
    output_dir  = "./Tiled-EDF-Cervical-Cytology-Images"
    ...
    generator = TiledImageMaskDatasetGenerator(size = size, 
                                ...
                                include_resized   = False,
                                augmentation = augmentation)
    generator.generate(images_dir, masks_dir, 
                        output_images_dir, output_masks_dir)
  except:
    traceback.print_exc()
