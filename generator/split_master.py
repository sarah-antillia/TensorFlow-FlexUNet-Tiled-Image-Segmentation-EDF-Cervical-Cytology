...
if __name__ == "__main__":
  try:
    images_dir = "./Tiled-EDF-Cervical-Cytology-Images/images/"
    masks_dir  = "./Tiled-EDF-Cervical-Cytology-Images/masks/"
    output_dir = "./Augmented-Tiled-EDF-Cervical-Cytology-ImageMask-Dataset/"
